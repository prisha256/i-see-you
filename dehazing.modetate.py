...
def get_dark_channel(image, window_size=25):
...
def get_transmission(image, A, omega=0.9, window_size=25):
    norm_image = image / A
...
def recover_image(image, transmission, A, t0=0.2):
...
image_path = "/home/shashank/Downloads/149.png"  
