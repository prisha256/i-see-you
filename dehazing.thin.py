...
def get_atmospheric_light(image, dark_channel, top_percent=0.0008):
...
def get_transmission(image, A, omega=0.75, window_size=8):
    norm_image = image / A
...
def recover_image(image, transmission, A, t0=0.05):
...
image_path = "/home/shashank/Downloads/235.png"  
